...
public static class IbmConverter
{
    ...
    private static readonly Encoding Ebcdic;
    ...
    /// <summary>
    ///     Returns a 16-bit signed integer converted from two bytes in a specified position encoding a big endian 16-bit
    ///     signed integer
    /// </summary>
    ...
    /// <summary>
    ///     Returns a 32-bit signed integer converted from four bytes at a specified position encoding a big endian 32-bit
    ///     signed integer
    /// </summary>
    ...
    private static readonly int _ibmBase = 16;
    private static readonly byte _exponentBias = 64;
    private static readonly int _threeByteShift = 16777216;
    ...
    /// </summary>
    /// <remarks>
    ///     From the java version made by p4w3l located here :
    ///     http://cobol2j.cvs.sourceforge.net/viewvc/cobol2j/cobol2j/src/main/java/net/sf/cobol2j/RecordSet.java?revision=1.25
    ///     &view=markup from
